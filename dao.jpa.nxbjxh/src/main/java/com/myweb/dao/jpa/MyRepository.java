...
public interface MyRepository{
    @Query("select new com.myweb.vo.XueFenVo(a.id,b.name,a.begintime,a.endtime,b.score,b.year) from Courserecord a ,Course b where a.course = b.id and a.user = ?1 and a.endtime is not null and a.endtime <> ''")
